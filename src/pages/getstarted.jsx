    ...
    <div className="w-full">
      ...
      >
        <div className="flex lg:flex-row flex-col mx-auto justify-around w-11/12">
          <div className="lg:w-4/12 w-11/12 ">
            ...
            <div className="flex lg:flex-row flex-col lg:justify-left lg:space-x-5 mt-8">
      ...
      <div className="w-9/12 mx-auto">
        <div className="flex lg:flex-row flex-col justify-between">
          ...
          <div className=" w-11/12 lg:w-4/12 lg:mt-32 mt-8">
      ...
      <div className="mx-auto h-[800px] lg:h-[700px] bg-gradient-to-r from-[#424A52] to-[#C1694F]">
        <div className="flex lg:flex-row space-y-9 flex-col mx-auto justify-between w-10/12">
          <div className="  lg:text-auto w-10/12 lg:w-4/12 mt-20 lg:mt-36">
            <p className="text-[white] text-2xl">
              Virtually explore properties from your home
            </p>
            <p className="text-[black] mt-8 text-[19px]">
          ...
          <div className="w-full justify-center  lg:w-6/12 flex lg:justify-end mt-22 lg:mt-32">
            <div
              style={bg}
              className=" rounded-lg flex justify-end bg-[url('/images/phonebackground.png')] h-[260px] lg:h-[400px] w-9/12 bg-cover bg-center bg-no-repeat "
            >
              <Image
                className="lg:mt-60 mt-24  lg:h-[700px] h-[350px]"
